...
export interface components {
  schemas: {
    ...
    HostManifests: {
      [key: string]: (string | components["schemas"]["HostManifest"]) | undefined;
    };
    ...
    LocalizedVersions: {
      [key: string]: components["schemas"]["BaseApplication"] | undefined;
    };
    ...
    Interop: {
      ...
      intents?: {
         ...
         */
        listensFor?: {
          [key: string]: components["schemas"]["Intent"] | undefined;
        };
        /**
