...
describe('EnhancedCustomAppList', () => {
  ...
  it('renders the enhanced custom app list', () => {
    ...
    expect(screen.getByText('Create and manage your custom FDC3 applications with proper icons, screenshots, and metadata.')).toBeInTheDocument()
    expect(screen.getByText('Click to Add A New Custom App')).toBeInTheDocument()
  })
  ...
  it('switches between web and native app types', async () => {
    ...
    expect(screen.queryByPlaceholderText('https://your-app.com')).not.toBeInTheDocument()
  })
