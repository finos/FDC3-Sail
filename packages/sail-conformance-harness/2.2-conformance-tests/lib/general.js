...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   appIdMatches: () => (/* binding */ appIdMatches),
/* harmony export */   failAfterTimeout: () => (/* binding */ failAfterTimeout),
/* harmony export */   handleFail: () => (/* binding */ handleFail),
...
function failAfterTimeout(timeoutMs = _constants__WEBPACK_IMPORTED_MODULE_1__["default"].WaitTime) {
...
function handleFail(documentation, ex) {
    const message = ex instanceof Error ? ex.message : String(ex);
    chai__WEBPACK_IMPORTED_MODULE_0__.assert.fail(documentation + message);
}
/**
 ...
 */
function appIdMatches(received, expected) {
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mock_functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mock-functions */ "./src/mock/mock-functions.ts");
...
(0,_finos_fdc3__WEBPACK_IMPORTED_MODULE_1__.getAgent)().then(async (fdc3) => {
    await (0,_mock_functions__WEBPACK_IMPORTED_MODULE_0__.closeWindowOnCompletion)(fdc3);
    //used in AOpensB1
    const implementationMetadata = await fdc3.getInfo();
    const { appId } = implementationMetadata.appMetadata;
    const appOpenedContext = {
        type: 'fdc3-conformance-opened',
    };
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_2__.appIdMatches)(appId, 'MockAppId')) {
    ...
    await (0,_mock_functions__WEBPACK_IMPORTED_MODULE_0__.sendContextToTests)(fdc3, appOpenedContext);
    // Context listeners used by tests.
    await fdc3.addContextListener('fdc3.instrument', async (context) => {
        // broadcast that this app has received context
        await (0,_mock_functions__WEBPACK_IMPORTED_MODULE_0__.sendContextToTests)(fdc3, {
