...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Fdc3CommandExecutor: () => (/* binding */ Fdc3CommandExecutor)
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/mock/constants.ts");

class Fdc3CommandExecutor {
    async executeCommands(orderedCommands, config, channelService) {
        let channel;
        //close ChannelsApp when test is complete
        await channelService.closeWindowOnCompletion(config.testId);
        for (const command of orderedCommands) {
            switch (command) {
                case _constants__WEBPACK_IMPORTED_MODULE_0__.commands.joinRetrievedUserChannel: {
                    channel = await channelService.joinRetrievedUserChannel(config.channelId);
                    break;
                }
                case _constants__WEBPACK_IMPORTED_MODULE_0__.commands.retrieveTestAppChannel: {
                    if (!config.channelId) {
                ...
                case _constants__WEBPACK_IMPORTED_MODULE_0__.commands.broadcastInstrumentContext: {
                ...
                case _constants__WEBPACK_IMPORTED_MODULE_0__.commands.broadcastContactContext: {
...
/***/ "./src/mock/support/channel-support.ts"
/*!*********************************************!*\
  !*** ./src/mock/support/channel-support.ts ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ChannelServiceImpl: () => (/* binding */ ChannelServiceImpl)
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants */ "./src/constants.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constants */ "./src/mock/constants.ts");
...
class ChannelServiceImpl {
    ...
    async closeWindowOnCompletion(testId) {
        ...
        const appControlChannel = await this.fdc3.getOrCreateChannel(_constants__WEBPACK_IMPORTED_MODULE_0__["default"].ControlChannel);
    ...
    async notifyTestOnCompletion(testId) {
        const appControlChannel = await this.fdc3.getOrCreateChannel(_constants__WEBPACK_IMPORTED_MODULE_0__["default"].ControlChannel);
    ...
    getBroadcastService(currentChannelType) {
        if (currentChannelType === _constants__WEBPACK_IMPORTED_MODULE_1__.channelType.app) {
    ...
    systemChannelBroadcastService = {
        broadcast: async (contextType, historyItems, _ignored, testId) => {
            for (let i = 0; i < historyItems; i++) {
                const context = {
                    type: contextType,
                    name: `History-item-${i + 1}`,
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _support_channel_support__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./support/channel-support */ "./src/mock/support/channel-support.ts");
/* harmony import */ var _finos_fdc3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @finos/fdc3 */ "./node_modules/@finos/fdc3/dist/src/index.js");
/* harmony import */ var _channel_command__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./channel-command */ "./src/mock/channel-command.ts");



(0,_finos_fdc3__WEBPACK_IMPORTED_MODULE_1__.getAgent)().then(fdc3 => {
    let firedOnce = false;
    fdc3.addContextListener('channelsAppContext', (context) => {
        if (firedOnce === false && context.type == 'channelsAppContext') {
            firedOnce = true;
            const commandExecutor = new _channel_command__WEBPACK_IMPORTED_MODULE_2__.Fdc3CommandExecutor();
            commandExecutor.executeCommands(context.commands, context.config, new _support_channel_support__WEBPACK_IMPORTED_MODULE_0__.ChannelServiceImpl(fdc3));
        }
    });
});
