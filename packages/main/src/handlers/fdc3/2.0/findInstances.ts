...
import { FDC3Message, FindInstancesData, SailTargetIdentifier } from "/@/types/FDC3Message";
import { View } from "/@/view";



export const findInstances = async (message: FDC3Message) : Promise<SailTargetIdentifier[]> => {
