...
export interface components {
  schemas: {
     ...
     */
    Application: components['schemas']['BaseApplication'] & {
    ...
    OtherAppDetails: { [key: string]: unknown };
    ...
    HostManifest: { [key: string]: unknown };
    ...
    /** @description (Deprecated v1 API version) An intent definition as defined by spec https://github.com/FDC3/Intents/blob/master/src/Intent.yaml */
    IntentV1: {
